...
{
    public class AddressInformationPutDTO
    {
    ...
    public class AddressInformationPutValidator : AbstractValidator<AddressInformationPutDTO>
    {
        public AddressInformationPutValidator()
        {
